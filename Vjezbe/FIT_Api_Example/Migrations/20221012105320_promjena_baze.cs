...
//Ovo je file/skripta koja je kreirana od strane Entity framework-a koja u sustini 
//kreira i inicijalizira  u bazi sve tabele koje imamo u modelima i samom DbContext-u;
//BITNO je razumijeti da ukoliko ne uradimo komandu update-database u package manager conzoli, 
//nista od promjena nece biti vidljivo;

//Komanda update-database izvrsava skriptu i kreira sve u samoj bazi;
namespace FIT_Api_Example.Migrations
{
    public partial class promjena_baze : Migration
    {
